...
describe('simpleCalculator tests', () => {
  ...
  test('should subtract two numbers', () => {
    ...
    expect(simpleCalculator({ a: 3, b: 3, action: Action.Subtract })).toBe(0);
  ...
  test('should return null for invalid action', () => {
    expect(simpleCalculator({ a: 2, b: 3, action: 'somInvalid' })).toBe(null);
  });

  test('should return null for invalid arguments', () => {
    expect(simpleCalculator({ a: 'two', b: 3, action: Action.Add })).toBe(null);
  });
});
